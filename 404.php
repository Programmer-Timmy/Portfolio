<head>
    ...
    <title>Tim van der Kloet - 404</title>
</head>
...
<div class="welcome">
    ...
    <h2 style="font-size: 20px; color: #777777">You may have typed the URL incorrectly or the page has been moved or
        deleted.</h2>
    <h2 style="font-size: 20px; color: #777777">Please check the URL or navigate back to the <a
                style="color: #55d6aa; text-decoration: none;" href="/home">home page</a>.</h2>
</div>
</body>
