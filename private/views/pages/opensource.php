...
<main class="container">
    <header class="welcome">
        ...
        <div class="text">
            <p>I believe in the power of open source software. Open source projects allow developers to collaborate,
                learn from each other, and create amazing software that can be used by anyone.
                Here are some of the projects I've contributed to. Click on a project to see more information.</p>
        </div>
                    ...
                    <article class="card h-100 shadow-sm project-card"
                        ...
                        <div class="card-footer bg-transparent border-top-0 d-flex justify-content-between align-items-center">
                            ...
                            <a href="<?= htmlspecialchars($project->url) ?>" target="_blank"
                               class="btn btn-sm hover-teal"
                               style="border: 1px solid #55d6aa; color: #55d6aa; position: relative; z-index: 2; border-radius: 20px; padding: 2px 10px; background: transparent;"
